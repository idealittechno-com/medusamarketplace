...
var resolveUserArguments = function (user) {
    return function () {
        ...
        var id = null;
        id = (_c = (_a = args.find(analytics_core_1.isString)) !== null && _a !== void 0 ? _a : (_b = args.find(analytics_core_1.isNumber)) === null || _b === void 0 ? void 0 : _b.toString()) !== null && _c !== void 0 ? _c : user.id();
        var objects = args.filter(function (obj) {
            if (id === null) {
                return (0, analytics_core_1.isPlainObject)(obj);
            }
