...
const Header = React.forwardRef(({ className, status = "not-started", children, ...props }, ref) => {
    return (React.createElement(Primitves.Header, { ref: ref, className: (0, clx_1.clx)("h3-core text-ui-fg-base group flex w-full flex-1 items-center gap-4 px-8", className), ...props },
...
const Content = React.forwardRef(({ className, ...props }, ref) => {
    return (React.createElement(Primitves.Content, { ref: ref, className: (0, clx_1.clx)("overflow-hidden", "data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down pl-24 pr-8", className), ...props }));
});
