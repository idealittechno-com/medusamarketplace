...
const displayVariants = cva(clx("text-ui-fg-base bg-ui-bg-field transition-fg shadow-buttons-neutral flex w-full items-center gap-x-2 rounded-md outline-none", "hover:bg-ui-bg-field-hover", "focus:shadow-borders-interactive-with-active data-[state=open]:shadow-borders-interactive-with-active", "disabled:bg-ui-bg-disabled disabled:text-ui-fg-disabled disabled:shadow-buttons-neutral", "aria-[invalid=true]:!shadow-borders-error"), {
    variants: {
        size: {
                ...
                React.createElement("div", { className: "flex items-start" },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("div", { className: "border-ui-border-base flex items-center gap-x-2 border-t p-3" },
                            React.createElement(Button, { variant: "secondary", className: "w-full", type: "button", onClick: onCancel }, "Cancel"),
                            React.createElement(Button, { variant: "primary", className: "w-full", type: "button", onClick: onApply }, "Apply"))))))));
};
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("div", { className: "flex items-center justify-between border-t p-3" },
                            ...
                            React.createElement("div", { className: "flex items-center gap-x-2" },
                                ...
                                React.createElement(Button, { variant: "primary", type: "button", onClick: onApply }, "Apply")))))))));
};
