...
const SubMenuTrigger = React.forwardRef(({ className, children, ...props }, ref) => (React.createElement(Primitives.SubTrigger, { ref: ref, className: clx("focus:bg-ui-bg-base-pressed data-[state=open]:bg-ui-bg-base-pressed txt-compact-small flex cursor-default select-none items-center rounded-sm px-3 py-2 outline-none", className), ...props },
    children,
...
const Label = React.forwardRef(({ className, ...props }, ref) => (React.createElement(Primitives.Label, { ref: ref, className: clx("text-ui-fg-subtle txt-compact-xsmall-plus px-2 py-1.5", className), ...props })));
