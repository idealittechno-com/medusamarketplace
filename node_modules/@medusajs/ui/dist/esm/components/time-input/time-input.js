...
const TimeSegment = ({ segment, state }) => {
    ...
    return (React.createElement("div", { ...segmentProps, ref: ref, className: clx("txt-compact-medium w-full rounded-md px-2 py-[5px] text-left uppercase tabular-nums", inputBaseStyles, "group-aria-[invalid=true]/time-input:!shadow-borders-error group-invalid/time-input:!shadow-borders-error", {
        ...
        React.createElement("span", { "aria-hidden": "true", className: clx("txt-compact-medium text-ui-fg-muted pointer-events-none block w-full text-left", {
