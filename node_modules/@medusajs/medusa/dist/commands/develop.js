...
function default_1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var args, argv, babelPath, COMMAND_INITIATED_BY, cliPath, child, _b, cli, binExists, backendUrl, adminChild_1;
        return __generator(this, function (_c) {
            ...
            (0, child_process_1.execSync)("\"".concat(babelPath, "\" src -d dist --ignore \"src/admin/**\""), {
                cwd: directory,
            ...
            _b = (0, resolve_admin_cli_1.resolveAdminCLI)(directory), cli = _b.cli, binExists = _b.binExists;
            if (binExists) {
            ...
            chokidar_1.default
                ...
                child.kill("SIGINT");
                (0, child_process_1.execSync)("".concat(babelPath, " src -d dist --extensions \".ts,.js\" --ignore \"src/admin/**\""), {
                    cwd: directory,
