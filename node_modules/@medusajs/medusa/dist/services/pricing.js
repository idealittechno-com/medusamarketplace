...
var PricingService = /** @class */ (function (_super) {
    ...
    PricingService.prototype.getProductVariantPricingModulePricing_ = function (variantPriceData, context) {
        return __awaiter(this, void 0, void 0, function () {
            var variables, query, variantPriceSets, variantIdToPriceSetIdMap, priceSetIds, queryContext, calculatedPrices, calculatedPriceMap, pricingResultMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        variables = {
                    ...
                    case 3:
                        ...
                        variantPriceData.forEach(function (_a) {
                            ...
                            if (priceSetId) {
                                var calculatedPrice = calculatedPriceMap.get(priceSetId);
                                if (calculatedPrice) {
                                    pricingResult.prices = [
                                        {
                                            id: (_b = calculatedPrice.calculated_price) === null || _b === void 0 ? void 0 : _b.money_amount_id,
                                            currency_code: calculatedPrice.currency_code,
                                            amount: calculatedPrice.calculated_amount,
                                            min_quantity: (_c = calculatedPrice.calculated_price) === null || _c === void 0 ? void 0 : _c.min_quantity,
                                            max_quantity: (_d = calculatedPrice.calculated_price) === null || _d === void 0 ? void 0 : _d.max_quantity,
                                            price_list_id: (_e = calculatedPrice.calculated_price) === null || _e === void 0 ? void 0 : _e.price_list_id,
                                        },
                                    ];
                                    pricingResult.original_price = calculatedPrice === null || calculatedPrice === void 0 ? void 0 : calculatedPrice.original_amount;
                                    pricingResult.calculated_price = calculatedPrice === null || calculatedPrice === void 0 ? void 0 : calculatedPrice.calculated_amount;
                                    pricingResult.calculated_price_type =
                                        (_f = calculatedPrice === null || calculatedPrice === void 0 ? void 0 : calculatedPrice.calculated_price) === null || _f === void 0 ? void 0 : _f.price_list_type;
                                }
                            }
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        variantIdMoneyAmountMap = priceSetMoneyAmounts.reduce(function (map, priceSetMoneyAmount) {
                            ...
                            var moneyAmount = __assign(__assign({}, priceSetMoneyAmount.money_amount), { region_id: null, price_list_id: (_b = priceSetMoneyAmount.price_list) === null || _b === void 0 ? void 0 : _b.id });
                            if (regionId) {
