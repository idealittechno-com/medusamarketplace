...
exports.default = (function (rootDirectory) {
    ...
    var _j = (0, medusa_core_utils_1.getConfigFile)(rootDirectory, "medusa-config"), configModule = _j.configModule, error = _j.error;
    if (error) {
    ...
    return {
        ...
        modules: (_f = configModule.modules) !== null && _f !== void 0 ? _f : {},
