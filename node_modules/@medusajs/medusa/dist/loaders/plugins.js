...
function registerSubscribers(pluginDetails, container, activityId) {
    return __awaiter(this, void 0, void 0, function () {
        var exclude, loadedFiles, files;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    exclude = [];
                    return [4 /*yield*/, new subscribers_1.SubscriberLoader(path_1.default.join(pluginDetails.resolve, "subscribers"), container, pluginDetails.options, activityId).load()
                        /**
                ...
                case 1:
                     ...
                     * Exclude any files that have already been loaded by the subscriber loader
                     */
                    exclude.push.apply(exclude, __spreadArray([], __read((loadedFiles !== null && loadedFiles !== void 0 ? loadedFiles : [])), false));
                    files = glob_1.default.sync("".concat(pluginDetails.resolve, "/subscribers/*.js"), {});
                    files
                        .filter(function (file) { return !exclude.includes(file); })
                        .forEach(function (fn) {
                        var loaded = require(fn).default;
