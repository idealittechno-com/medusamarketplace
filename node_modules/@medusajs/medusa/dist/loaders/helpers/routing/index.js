 ...
 * out-of-the-box.
 */
function getBodyParserMiddleware(sizeLimit) {
    return [
        (0, express_1.json)({ limit: sizeLimit }),
...
var RoutesLoader = /** @class */ (function () {
    ...
    RoutesLoader.prototype.applyBodyParserMiddleware = function (path, method) {
        ...
        if (mostSpecificConfig === null || mostSpecificConfig === void 0 ? void 0 : mostSpecificConfig.bodyParser) {
            ...
            (_b = this.router)[method.toLowerCase()].apply(_b, __spreadArray([path], __read(getBodyParserMiddleware(sizeLimit)), false));
            return;
        }
        return;
    };
