...
function mikroOrmConnectionLoader(_a) {
    var _b, _c;
    var container = _a.container, options = _a.options, moduleDeclaration = _a.moduleDeclaration, entities = _a.entities, pathToMigrations = _a.pathToMigrations;
    return __awaiter(this, void 0, void 0, function () {
        var manager, dbConfig, shouldSwallowError, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, loadShared({ container: container, entities: entities, pathToMigrations: pathToMigrations })];
                case 1: return [2 /*return*/, _e.sent()];
                case 2:
                    shouldSwallowError = !!((_b = options === null || options === void 0 ? void 0 : options.database) === null || _b === void 0 ? void 0 : _b.connection);
                    dbConfig = __assign(__assign({}, (0, load_module_database_config_1.loadDatabaseConfig)("product", (options !== null && options !== void 0 ? options : {}), shouldSwallowError)), { connection: (_c = options === null || options === void 0 ? void 0 : options.database) === null || _c === void 0 ? void 0 : _c.connection });
...
function loadShared(_a) {
    var container = _a.container, entities = _a.entities, pathToMigrations = _a.pathToMigrations;
    return __awaiter(this, void 0, void 0, function () {
