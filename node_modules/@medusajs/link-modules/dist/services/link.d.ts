...
export default class LinkService<TEntity> {
    ...
    softDelete(data: any, sharedContext?: Context): Promise<[string[], Record<string, string[]>]>;
    restore(data: any, sharedContext?: Context): Promise<[string[], Record<string, string[]>]>;
}
export {};
